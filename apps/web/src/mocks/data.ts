import type { FactionSummary, ObjectiveNode, Army, Settlement, Cell, Alert } from '../../../../packages/schema/ts/types'
...
const mockObjectives: ObjectiveNode[] = [
  { id: 'o1', title: 'Asegurar el Paso del Dragón', status: 'active' },
  {
    id: 'o2',
    title: 'Equilibrar Balanza Comercial (Norte)',
    status: 'blocked',
    children: [
...
export const mockFaction: FactionSummary = {
  id: 'F1',
...
export const mockSettlement: Settlement = {
  ...
  garrison: 500,
  ownerStateId: 'F1',
  tradeLinks: [{ toSettlementId: 'S02', volume: 800 }],
}

export const mockArmy: Army = {
  id: 'A01',
  stateId: 'F1',
  locationCellId: 1024,
  strength: 8000,
  supply: 65,
  stance: 'move',
  composition: { inf: 5000, cav: 2000, arty: 1000 },
  orders: [{ kind: 'move', etaTick: 250, pathLen: 12 }],
}
